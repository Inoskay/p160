AFRAME.registerComponent("tour", {
  ...
  init: function() {
    ...
    // this.cameraEl = document.query("#camera");
    // this.cameraEl = document.querySelector("#camera");
     this.cameraEl = document.querySelector("camera");
    // this.cameraEl = document.createElement("#camera");
  ...
  hideEl: function(elList) {
    elList.map(el => {
      //set the visibility for element(el) according to function
  ...
  showView: function() {
    ...
    // need to use sky 360 view so call the ID of sky tag from index.html
    const skyEl = document.querySelector('main-container')
    skyEl.setAttribute('material',{
      src:`./assets/360_images/${selectedPlace}/place.jpg`,
      color: '#fff'
    })
